...
<div class="container mx-auto w-full text-center pt-32">
    ...
    <form method="POST" action="/orders/<?php echo $order['ID'] ?>/update" class="flex flex-col items-center">
        <div class="w-1/2">
            ...
            <select name="product_id" id="product_id" class="w-full border py-1 px-4 my-2 rounded-xl" required>
                ...
                <?php foreach ($products as $product): ?>
                    <option value="<?php echo $product['ID'] ?>"<?php echo $product['ID'] == $order['product_id'] ? 'selected' : '' ?>>
