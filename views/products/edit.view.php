...
<div class="container mx-auto w-full text-center pt-32">
    ...
    <form method="POST" action="/products/update" class="flex flex-col items-center">
        ...
        <div class="w-1/2">
            ...
            <input type="text" name="name" id="name" value="<?= $product['name'] ?>" class="w-full border py-1 px-4 my-2 rounded-xl" required>
        </div>
        <div class="w-1/2 mt-4">
            <label for="description" class="block text-gray-700 text-sm font-bold mb-2">Description:</label>
            <textarea name="description" id="description" class="w-full border py-1 px-4 my-2 rounded-xl" required><?= $product['description'] ?></textarea>
        </div>
        <div class="w-1/2 mt-4">
